...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { location: @pin.location, pin_lat: @pin.pin_lat, pin_lng: @pin.pin_lng } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { location: @pin.location, pin_lat: @pin.pin_lat, pin_lng: @pin.pin_lng } }
